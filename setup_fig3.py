...
SISFlag = False
PrepmvXtFlag = False
prllz=1 # preprocessing parallel parameter
...
sim_setup(rseed, n, d_Vec, M_Vec, alpha, Sigma_type, K_Vec, OMPFlag, DebLassoFlag, SISFlag, PrepmvXtFlag, noise_sigma,
          t_min_Vec, NumOfSig, L_factor, dir_name, theta_ind_type, theta_sign_type, theta_amp_type, prllz=prllz, DJOMPunFlag=DJOMPunFlag)